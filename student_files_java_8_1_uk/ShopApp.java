...
class Item implements Scannable {
  ...
  public String toString() {
    ...
    return String.format("%-10s: %.2f", getName(), getPrice());
  }
...
class Course extends Education implements Scannable {
  private String name;
  private int days;
  ...
  public String toString() {
    // return string information about this object
    return String.format("%-10s %.2f =>(%d days)", name, price, days);
  }
}
...
public class ShopApp {
  ...
  public static void main(String args[]) {
    ...
    register.scan(milk);
    register.pay();
    Course c = new Course("Java", 10, 3500);
    register.scan(c);
    register.pay();
  }
}
